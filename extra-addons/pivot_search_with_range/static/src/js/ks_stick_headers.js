...
'use strict';
    ...
    var ks_pivot_status_header = true;
    ks_PivotRenderer.include({
        on_attach_callback: function(){
           var ks_sup = this._super.apply(this, arguments);
           var ks_self = this;
           console.log("ks_Session");
           console.log(ks_Session);
           if(ks_pivot_status_header){
        ...
        ks_stickPivotView:function(el){
           ...
           if(ks_el.parents(".o_dashboard").length===0){
                   ks_el.each(function () {
                           $(this).stickyTableHeadersPivot({scrollableArea: ks_o_content_area, fixedOffset: 0.1,stickStatus: ks_pivot_status_header});
                    });
            }
